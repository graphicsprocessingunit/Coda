...
**Android** — [Download APK v1.4.0](https://github.com/graphicsprocessingunit/Coda/releases/download/v1.4.0/Coda-v1.4.0.apk)

**iOS** — [Download IPA v1.4.0](https://github.com/graphicsprocessingunit/Coda/releases/download/v1.4.0/Coda-v1.4.0.ipa), install via [AltStore](https://altstore.io) or [SideStore](https://sidestore.io).
